  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-teal-50 to-cyan-100 flex items-center justify-center p-4">
      <div className="max-w-2xl w-full">
        ...
        <div className="text-center mb-8">
          <Link href="/">
            <div className="w-16 h-16 bg-gradient-to-br from-teal-600 to-teal-800 rounded-2xl flex items-center justify-center mx-auto mb-4 cursor-pointer transform transition-all duration-200 hover:scale-105">
              <span className="text-white font-bold text-2xl">B</span>
            </div>
          </Link>
          <h1 className="text-3xl font-bold text-slate-800">Create Account</h1>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 animate-fade-in">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                ...
                <input
                  ...
                  value={formData.name}
                  onChange={handleChange}
                  className="w-full px-4 py-3 text-teal-900 bg-gray-100 rounded-lg placeholder:text-slate-400 focus:outline-none border-none focus:ring-2 focus:ring-teal-600 transition-all duration-200"
                  placeholder="Enter your full name"
                  required
                />
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    value={formData.password}
                    onChange={handleChange}
                    className="w-full px-4 py-3 text-teal-900 bg-gray-100 pr-12 rounded-lg placeholder:text-slate-400 focus:outline-none border-none focus:ring-2 focus:ring-teal-600 transition-all duration-200"
                    placeholder="Enter your password"
                    required
                  />
                  <button
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-teal-600 text-white py-3 px-4 rounded-lg hover:bg-teal-700 focus:ring-2 focus:ring-teal-500 focus:ring-offset-2 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed font-medium"
            >
              {loading ? (
                <div className="flex items-center justify-center">
                  <div className="animate-spin rounded-full h-5 w-5 border-b-2 border-white mr-2"></div>
